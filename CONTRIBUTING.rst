...
``eeharvest`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``eeharvest``'s files. While this mechanism can
...
#. Install |pre-commit|_::
   ...
   ``eeharvest`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/eeharvest
.. _issue tracker: https://github.com/<USERNAME>/eeharvest/issues
.. <-- end -->
